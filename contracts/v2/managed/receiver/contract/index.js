...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      ...
      receiveShieldedTokenFromIssuer: async (...args_1) => {
        if (args_1.length !== 5) {
        ...
        const result_0 = await this._receiveShieldedTokenFromIssuer_0(context,
                                                                      partialProofData,
                                                                      issuerAddress_0,
                                                                      mintEntryPoint_0,
                                                                      issuerCallCommitment_0,
      ...
      receiveUnshieldedTokenFromIssuer: async (...args_1) => {
        if (args_1.length !== 6) {
        ...
        const result_0 = await this._receiveUnshieldedTokenFromIssuer_0(context,
                                                                        partialProofData,
                                                                        issuerAddress_0,
                                                                        mintEntryPoint_0,
                                                                        issuerCallCommitment_0,
    ...
    if (_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                  ...
                                                                  [
                                                                   ...
                                                                   { popeq: { cached: false,
                                                                              result: undefined } }]).value))
    {
      __compactRuntime.assert(this._equal_7(_descriptor_8.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                      partialProofData,
                                                                                                      [
                                                                                                       { dup: { n: 0 } },
                                                                                                       { idx: { cached: false,
  ...
  async _receiveShieldedTokenFromIssuer_0(context,
                                          partialProofData,
                                          issuerAddress_0,
                                          mintEntryPoint_0,
                                          issuerCallCommitment_0,
                                          coin_0)
  {
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: true, n: 2 } },
                                       { swap: { n: 0 } }]);
    await this._receiveShieldedToken_0(context, partialProofData, coin_0);
    return [];
  }
  ...
  async _receiveUnshieldedTokenFromIssuer_0(context,
                                            partialProofData,
                                            issuerAddress_0,
                                            mintEntryPoint_0,
                                            issuerCallCommitment_0,
                                            ...
                                            amount_0)
  {
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: true, n: 2 } },
                                       { swap: { n: 0 } }]);
    await this._receiveUnshieldedToken_0(context,
                                         partialProofData,
                                         color_0,
                                         amount_0);
    return [];
...
export const expectedVk = {
  ...
  'receiveShieldedTokenFromIssuer': 'f23bed1854a728897348f4867db82db80c82daea3876fe7582c47cf8d7bf9b08',
  'receiveUnshieldedToken': 'da4ebf3a7012a7f9275a266c46f06c0a05b16783ce39c1355539862bc29cf31a',
  'receiveUnshieldedTokenFromIssuer': 'cde1c9e0c12abf51cf6b159a54fbea3237c8624231dd60d18d5615443fda3c1e',
