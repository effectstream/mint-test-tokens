...
export type ImpureCircuits<PS> = {
  ...
  spendShieldedToken(context: __compactRuntime.CircuitContext<PS>,
                     ...
                     amount_0: bigint): Promise<__compactRuntime.CircuitResults<PS, { nonce: Uint8Array,
                                                                                      color: Uint8Array,
                                                                                      value: bigint
                                                                                    }>>;
  getShieldedBalance(context: __compactRuntime.CircuitContext<PS>): Promise<__compactRuntime.CircuitResults<PS, bigint>>;
  getShieldedColor(context: __compactRuntime.CircuitContext<PS>): Promise<__compactRuntime.CircuitResults<PS, Uint8Array>>;
